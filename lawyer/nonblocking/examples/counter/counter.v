...
Lemma counter_wfree_spec (l: loc)
  ...
  ⊢ wait_free_method_gen NotStuck (incr l) d_wfr0 (fun _ => 5%nat) (fun _ => True) (fun _ => True).
Proof using.
  simpl. rewrite /wait_free_method_gen. 
  iIntros "#INV" (τ π a). iIntros "!> %Φ (CPS & PH & ?) POST".
