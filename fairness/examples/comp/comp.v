...
Section ClientDefs.
  ...
  Definition client_lr (st: client_state): gset (client_role) :=
    filter (fun r => (@bool_decide _ (lib_step_dec st r) = true))  
      {[ inl $ inl ρlg; inl $ inr $ env (eiG ρlg) (EM := ExtLibLM); inr ρy ]}. 
