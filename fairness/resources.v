...
Qed.
  ...
  Lemma actual_update_step_still_alive_strong
        (extr : execution_trace Λ)
        (auxtr: auxiliary_trace LM)
  ...
  Proof.
    iIntros (Hfr_new Hstash_own Hstash_dis Hstash_rem Htrlast Hauxtrlast Hstep Htrans Hfuelsval) "Hfuel Hmod Hsi Hfr1".
    ...
    { simpl. rewrite /update_fuel_resource /fuel_apply.
      ...
      + apply elem_of_equiv_empty_L. intros ρ' [Hin1 Hin2]%elem_of_intersection.
        ...
        { set_solver. }
        { apply elem_of_difference in Hin2 as [DOM NODOM].
          apply elem_of_union in DOM as [? | DOM].
          { set_solver. }
          (* apply not_elem_of_difference in NODOM.  *)
          clear NODOM.
          foobar. check how free roles outside of fr1 were handled before. 
