...
Section trace_proof.
  ...
  Proof.
    ...
    rewrite /commit_spec.
    iModIntro.
    iIntros (c sa) "(#Hconn & %Hsa_in_clients & %Hsa_extract & (%γ & #Hsa'_pointer)) !# %Φ %E %Hsub Hshift".
  ...
  Proof.
      ...
      HOwnLin' Hpost_res' Hlin_res']").
    {
      ...
      assert (lin_trace_of (lt' ++ [(#tag1, (c, (#"RdLin", (#k, $ wo))))%V]) t') as Hlin_of_add.
      {
      ...
      iAssert (⌜valid_sequence (lt' ++ [(#tag1, (c, (#"RdLin", (#k, $ wo))))%V])⌝)%I as "%Hvalid_seq_add".
      {
      ...
      - iExists (T' ++ [[Rd (tag1, c) k wo]]), exec'.
        ...
        iSplit; first done.
        iSplit; first (iPureIntro; set_solver).
        iSplit; first (iPureIntro; destruct wo; by apply (extraction_of_add1 _ _ _ _ tag1)).
        iSplit.
        + iPureIntro.
  ...
  Proof.
    ...
    iSplitR.
    {
      ...
      iIntros (c sa k v) "!# #Hin #Hconn %Φ %E % !# Hshift".
