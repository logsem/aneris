...
Section Client_Proxy_Proof.
  ...
  Proof.
    ...
    iMod (own_alloc (Excl ())) as (γU) "Hu"; first done.
    ...
    - iIntros (lk γ) "#Hlk".
      iMod (own_update _ _ (Cinr (to_agree (γA, γS, γ, γCache, γMsnap, γU))) with "Hp") as "#Hdefined".
      ...
      iExists (lk, (reqh, #l))%V, γCst, γA, γS, γ, γCache, γMsnap, γU.
      by iFrame "#∗".
  Qed.
