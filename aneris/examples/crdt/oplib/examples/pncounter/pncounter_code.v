...
<repository_root>/ml_sources/examples/crdt/oplib/examples/pncounter/pncounter_code.ml *)
...
Definition pncounter_init_st : val := λ: <>, #0.

Definition pncounter_crdt : val :=
  λ: <>, (pncounter_init_st, pncounter_effect).
