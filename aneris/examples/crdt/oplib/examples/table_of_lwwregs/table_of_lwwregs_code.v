...
<repository_root>/ml_sources/crdt/oplib/examples/table_of_lwwregs/table_of_lwwregs_code.ml *)
...
Definition table_of_lwwregs_effect : val :=
  λ: "msg" "st", map_comb_effect lwwreg_init_st lwwreg_effect "msg" "st".

Definition table_of_lwwregs_init_st : val := λ: <>, map_comb_init_st #().

Definition table_of_lwwregs_crdt : val :=
  λ: <>, (table_of_lwwregs_init_st, table_of_lwwregs_effect).
