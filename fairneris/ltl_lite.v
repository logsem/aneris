...
Section ltl_lemmas.
  ...
  Proof.
    ...
    assert ((∀ m, m < n → ∃ tr', after m tr = Some tr' ∧ (trace_not (↓ P)) tr') ∨
              ¬ (∀ m, m < n → ∃ tr', after m tr = Some tr' ∧ (trace_not (↓ P)) tr')) as [HP|HP];
  ...
  Lemma trace_not_eventually_always_not P (tr : trace S L) :
